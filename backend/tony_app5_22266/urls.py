"""tony_app5_22266 URL Configuration
...
admin.site.site_header = "tony-app5"
admin.site.site_title = "tony-app5 Admin Portal"
admin.site.index_title = "tony-app5 Admin"

# swagger
api_info = openapi.Info(
    title="tony-app5 API",
    default_version="v1",
    description="API documentation for tony-app5 App",
)
